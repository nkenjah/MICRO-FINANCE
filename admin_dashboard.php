...
$query = "SELECT COUNT(*) as total_staffs FROM users WHERE role ='staff'";
...
$totalMembers = $row['total_staffs']; // Corrected from 'total_members' to 'total_staffs'
?>
      ...
      <div class="row">
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">staffs <span>| Total</span></h5>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo $totalMembers." staffs"; ?></h6>
